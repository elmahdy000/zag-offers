...
- **Real-time:** Ready for socket/push notifications.

---

## 🎯 Message for Stitch / Design Agent:
> "Stitch, use this brief to design a high-fidelity UX/UI. Focus on accessibility, Arabic RTL support, and a premium mobile-first approach. Ensure all components map to the existing backend services. Pay special attention to 'Empty States' and 'Status Badges' for the Admin/Merchant workflow."
