...
Future<void> _firebaseMessagingBackgroundHandler(RemoteMessage message) async {
  ...
  final title =
      message.notification?.title ?? message.data['title'] ?? 'تنبيه إداري';
  final body = message.notification?.body ?? message.data['body'] ?? '';

  // Firebase displays notification payloads in the background. Data-only
  // messages still need a local notification generated by the app.
        ...
        home: BlocBuilder<AuthBloc, AuthState>(
          ...
          builder: (context, state) {
            if (state is AuthAuthenticated) {
              ...
              return const Scaffold(body: CardSkeleton());
            } else {
