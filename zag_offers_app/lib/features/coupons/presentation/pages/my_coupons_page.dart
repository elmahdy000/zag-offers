            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color:
                      Colors.white, // Keep QR background white for readability
    ...
    return Scaffold(
      ...
      body: !_isLoggedIn
          ...
          : BlocBuilder<CouponsBloc, CouponsState>(
              buildWhen: (prev, next) =>
                  next is UserCouponsLoaded ||
                  next is CouponsLoading ||
                  next is CouponsInitial ||
                            ...
                            children: [
                              ListTile(
                                onTap: () => Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (_) =>
                                        OfferDetailPage(offer: coupon.offer),
                                  ),
                                ),
                                    ...
                                    if (coupon.offer.newPrice != null)
                                      Row(
                                        children: [
                                          ...
                                          if (coupon.offer.oldPrice !=
                                              null) ...[
                                            const SizedBox(width: 6),
                                            Text(
                                              coupon.offer.oldPrice!
                                                  .toStringAsFixed(0),
                                              style: TextStyle(
                                                decoration:
